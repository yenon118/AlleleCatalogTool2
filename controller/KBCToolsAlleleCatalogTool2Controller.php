...
class KBCToolsAlleleCatalogTool2Controller extends Controller
{
    ...
    public function ViewVariantAndPhenotypePage(Request $request, $organism) {
        ...
        // Return to view
        return view('system/tools/AlleleCatalogTool2/viewVariantAndPhenotype')->with('info', $info);
    }
    ...
    public function ViewVariantAndPhenotypeFiguresPage(Request $request, $organism) {
        ...
        // Return to view
        return view('system/tools/AlleleCatalogTool2/viewVariantAndPhenotypeFigures')->with('info', $info);
    }
