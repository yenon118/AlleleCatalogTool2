...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('system/home/AlleleCatalogTool2/css/modal.css') }}">
...
<body>
    <!-- Back button -->
    <a href="{{ route('system.tools.AlleleCatalogTool2', ['organism'=>$organism]) }}"><button> &lt; Back </button></a>
...
<script src="{{ asset('system/home/AlleleCatalogTool2/js/modal.js') }}" type="text/javascript"></script>
<script src="{{ asset('system/home/AlleleCatalogTool2/js/viewAllByGenes.js') }}" type="text/javascript"></script>
